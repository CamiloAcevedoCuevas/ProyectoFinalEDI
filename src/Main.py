...
def main():
    ...
    gui.set_label('El Poder De Un Click', 24, 0.5, 0.15, 'dodgerBlue4')
    def start():
        scenes.scene = 'start'
        menu.destroy()
    def exit():
        menu.destroy()
    gui.set_button('Iniciar Partida', start, 0.4, 0.8, 150, 40, 'dodgerBlue4')
    gui.set_button('Salir', exit, 0.6, 0.8, 150, 40, 'dodgerBlue4')
    menu.mainloop()
